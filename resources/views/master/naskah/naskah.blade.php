...
<div class="page-heading">
            ...
            <div class="col-12 col-md-4 order-md-2 order-last">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Naskah Dinas</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <table class="table table-hover table-striped" id="tableNaskah">
                    <thead class="table-dark">
                        <tr>
                            <th class="text-center" width="100px">Action</th>
                            <th class="text-left" width="20px">No.</th>
                            <th class="text-left" width="100px">Naskah</th>
                            <th class="text-left" width="100px">Nilai</th>
                            <th class="text-left" width="100px">Keterangan</th>
...
@include('master.naskah.table.list-naskah')
